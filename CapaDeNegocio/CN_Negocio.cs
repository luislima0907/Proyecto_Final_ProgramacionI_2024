...
namespace CapaDeNegocio
{
    ...
    {
        // instanciamos CD_Negocio en la capa de Negocio
        ...
        // creamos y llamamos a los metodos de registrar, editar y eliminar Negocio
        public bool GuardarDatos(Negocio objNegocio, out string Mensaje)
        {
            ...
            if (objNegocio.RUC == "") Mensaje += "Es necesario añadir el numero de RUC del Negocio.\n";
            if (objNegocio.Direccion == "") Mensaje += "Es necesario añadir la direccion del Negocio.\n";
